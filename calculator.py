...
label = Label(window, textvariable = equation_label, font = ('roboto', 10), bg = "white", width = 40, height = 5)
...
devide = Button(frame, text = '/', height = 4, width = 9, font = 35, command = lambda: button_press("/"))
